...
def compute_reward(data: DataProto, reward_fn: AbstractRewardManager, use_dm=False, deepthought=False) -> tuple[torch.Tensor, dict[str, Any]]:
    """
    ...
    """
    try:
        reward_result = reward_fn(data, return_dict=True, use_dm=use_dm, deepthought=deepthought)
